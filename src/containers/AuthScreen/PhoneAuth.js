  ...
  _verifyCode = () => {
    ...
    setTimeout(async () => {
      ...
      try {
        ...
        setTimeout(() => {
          Alert.alert('Oops!', 'You have entered wrong code.');
        }, 100);}
...
AppRegistry.registerComponent('PhoneAuth', () => PhoneAuth);
